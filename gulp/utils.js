module.exports = function () {
  ...
  function startBrowserSync(isDev, specRunner) {
    ...
    // If dev: watches sass and typescript, compiles it to css and javascript, browser-sync handles reload
    if (isDev) {
      //gulp.watch([config.sass, config.ts.clientts, config.ts.serverts], ['build:styles', 'tsc:client', 'tsc:server'])
